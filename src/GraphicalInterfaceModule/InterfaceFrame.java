...
public class InterfaceFrame extends JFrame
{
	...
	public static int minCarGenInterval = 1;
	public static int maxCarGenInterval = 1;
	...
	public InterfaceFrame()
	{
		...
		final JTextField editMinInterval = new JTextField("1",4);
		final JButton btnSetMinInterval = new JButton("Ustaw min. l. samochodów / takt.");
		final JTextField editMaxInterval = new JTextField("1",4);
		final JButton btnSetMaxInterval = new JButton("Ustaw maks. l. samochodów / takt.");
		...
		controlPanel.add(editMinInterval);
		controlPanel.add(btnSetMinInterval);
		controlPanel.add(editMaxInterval);
		controlPanel.add(btnSetMaxInterval);
		
		btnSetMaxInterval.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				maxCarGenInterval = tryParse(editMaxInterval.getText());
			}
		});
		
		btnSetMinInterval.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				minCarGenInterval = tryParse(editMinInterval.getText());
			}
		});
